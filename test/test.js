...
/* TODO: implement randomGlitch, glitch, and preset1-4
gleech.read('./test.jpg', function (err, img) {
	if (err) { throw new Error(err); }
...
gleech.read('./test.jpg', function (err, img) {
	if (err) { throw new Error(err); }
	img.preset1().write('test_preset1.jpg');
});


gleech.read('./test.jpg', function (err, img) {
	if (err) { throw new Error(err); }
	img.preset2().write('test_preset2.jpg');
});


gleech.read('./test.jpg', function (err, img) {
	if (err) { throw new Error(err); }
	img.preset3().write('test_preset3.jpg');
});


gleech.read('./test.jpg', function (err, img) {
	if (err) { throw new Error(err); }
	img.preset4().write('test_preset4.jpg');
});
...
gleech.read('./test.jpg', function (err, img) {
	if (err) { throw new Error(err); }
	img.slice2().write('test_slice2.jpg');
});


gleech.read('./test.jpg', function (err, img) {
	if (err) { throw new Error(err); }
	img.slice3().write('test_slice3.jpg');
});
*/
...
gleech.read('./test.jpg', function (err, img) {
	if (err) { throw new Error(err); }
	img.fractalGhosts2().write('test_fractalGhosts2.jpg');
});


gleech.read('./test.jpg', function (err, img) {
	if (err) { throw new Error(err); }
	img.fractalGhosts3().write('test_fractalGhosts3.jpg');
});

gleech.read('./test.jpg', function (err, img) {
	if (err) { throw new Error(err); }
	img.fractalGhosts4().write('test_fractalGhosts4.jpg');
});
*/
...
gleech.read('./test.jpg', function (err, img) {
	if (err) { throw new Error(err); }
	img.fractal2().write('test_fractal2.jpg');
});
*/
